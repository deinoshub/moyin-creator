...
<p align="center">
  <a href="README.md">🇨🇳 中文</a> | <a href="README_EN.md">🇬🇧 English</a> | <strong>🇻🇳 Tiếng Việt</strong>
</p>
...
**Moyin Creator** (魔因漫创) là công cụ sản xuất phim và anime bằng AI. Five interconnected modules cover the entire pipeline from script to final video:

> **📝 Script → 🎭 Characters → 🌄 Scenes → 🎬 Director → ⭐ S-Class (Seedance 2.0)**

Mỗi bước tự chảy sang bước sau. Trong app, mở Cài đặt (hoặc thanh tiêu đề dự án) để chọn ngôn ngữ: Tiếng Việt, English, 中文, hoặc theo hệ thống.
...
Sau khi mở app, vào **Cài đặt → API** và điền API key nhà cung cấp AI.
...
Hoan nghênh đóng góp! Xem [hướng dẫn đóng góp](CONTRIBUTING.md).
